...
CKPT_DIR="/home/nvme02/wlx/Memory/models/lingbot-world-base-act"                # lingbot-world 预训练权重目录
DATASET_DIR="/home/nvme02/wlx/Memory/datasets/processed_csgo_v3"             # CSGO 数据集目录（含 metadata_train.csv）
