...
load_weights=$YOUR_PATH_TO_CAMBRIANS_S2_WEIGHTS
data_path=$YOUR_PATH_TO_CAMBRIANS_3M_JSONL
image_folder=$YOUR_PATH_TO_CAMBRIANS_3M_IMAGES
video_folder=$YOUR_PATH_TO_CAMBRIANS_3M_VIDEOS
...
TRAIN_ARGS="
    ...
    --logging_steps 1 \
    --tf32 False \
    --model_max_length ${max_seq_len:-8192} \
